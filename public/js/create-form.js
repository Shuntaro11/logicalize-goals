$(function(){
  ...
  $("#nextBtn1").on('click', function(e) {
    ...
    $("#markNumber2").css("box-shadow", "0 5px 14px 0 rgba(0,0,0,.1)");
  ...
  $("#prevBtn2").on('click', function(e) {
    ...
    $("#markNumber1").css("box-shadow", "0 5px 14px 0 rgba(0,0,0,.1)");
  ...
  $("#nextBtn2").on('click', function(e) {
    ...
    $("#markNumber3").css("box-shadow", "0 5px 14px 0 rgba(0,0,0,.1)");
  ...
  $("#nextBtn3").on('click', function(e) {
    ...
    $("#markNumber4").css("box-shadow", "0 5px 14px 0 rgba(0,0,0,.1)");
  ...
  $("#nextBtn4").on('click', function(e) {
    ...
    $("#markNumber5").css("box-shadow", "0 5px 14px 0 rgba(0,0,0,.1)");
